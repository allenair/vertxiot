...
public class ElevatorDaoImpl {
	...
	public Completable insertAnalysisDb(JsonObject analyBean) {
		...
		array.add(analyBean.getString("fl"));
		array.add(analyBean.getString("cnt"));
		array.add(analyBean.getString("ddfw"));
		array.add(analyBean.getString("hxxh"));
		...
		array.add(analyBean.getString("last_count"));
		array.add(analyBean.getString("total_time"));
		array.add(analyBean.getString("driver_err"));
		array.add(analyBean.getString("logic_lock"));
		array.add(analyBean.getString("sys_model"));
		array.add(analyBean.getString("xh_time"));
		array.add(analyBean.getString("arm_code"));
		array.add(analyBean.getString("dsp_code"));
